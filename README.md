...
- `Review#rating`
  X returns the rating for the `Review` instance
- `Review.all`
  X returns an array of all initialized `Review` instances
...
- `Viewer#reviews`
  X returns an array of `Review` instances associated with the `Viewer` instance.
- `Viewer#reviewed_movies`
  X returns an array of `Movie` instances reviewed by the `Viewer` instance.
...
- `Movie#reviewers`
  X returns an array of all of the `Viewer` instances that reviewed the `Movie`.
...
- `Viewer#reviewed_movie?(movie)`
  X a `Movie` instance is the only argument
  X returns `true` if the `Viewer` has reviewed this `Movie` (if there is a `Review` instance that has this `Viewer` and `Movie`), returns `false` otherwise
- `Viewer#rate_movie(movie, rating)`
  X a `Movie` instance and a rating (number) are passed in as arguments
